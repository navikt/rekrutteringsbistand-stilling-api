...
class StillingService(
    ...
    fun oppdaterRekrutteringsbistandStilling(
        ...
        if(dto.stilling.source == "DIR") {
            ...
            log.info("Versjon på stillinger. Oppdatert: ${dto.stilling.versjon}, tidligere: ${eksisterendeStilling?.versjon}")
        ...
        val oppdatertStilling = arbeidsplassenKlient.oppdaterStilling(stilling.toArbeidsplassenDto().copy(
