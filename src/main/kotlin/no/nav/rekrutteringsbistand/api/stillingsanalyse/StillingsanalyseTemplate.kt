...
object StillingsanalyseTemplate {
    ...
    fun lagPrompt(stillingsanalyseDto: StillingsanalyseController.StillingsanalyseDto): String =
        ...
        **Unntak:** Hvis ordet brukes i sammenheng med stillingen som skal besettes (for eksempel "IPS veileder"), skal det ikke anses som sensitivt. Dette gjelder også for mange andre ord i listen over sensitive ord.Det er ikke noe galt i å søke etter noen som skal jobbe med sensitive ting.
